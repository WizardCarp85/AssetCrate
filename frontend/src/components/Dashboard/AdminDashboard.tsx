                    ...
                    <div className="mb-12">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {data.pendingAssets.map((asset: any) => (
                                <div
                                    key={asset._id}
                                    className="bg-gradient-to-br from-[#111]/80 to-[#0a0a0a]/80 backdrop-blur-xl rounded-2xl border border-yellow-500/30 p-6"
                                >
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <div className="flex gap-3 mt-4">
                                                ...
                                                <button
                                                    ...
                                                    className="px-6 py-2 bg-green-500/20 border border-green-500/30 text-green-400 rounded-lg hover:bg-green-500/30 transition-colors text-sm font-semibold flex items-center gap-2 disabled:opacity-50"
                                                >
                                                    <FaCircleCheck />
                                                ...
                                                <button
                                                    ...
                                                    disabled={approving === asset._id}
                                                    className="px-6 py-2 bg-red-500/20 border border-red-500/30 text-red-400 rounded-lg hover:bg-red-500/30 transition-colors text-sm font-semibold flex items-center gap-2 disabled:opacity-50"
                                                >
                                                    <FaCircleXmark />
                                                    Reject
                                                </button>
