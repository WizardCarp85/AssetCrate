        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#050505]">
            <div className="relative flex flex-col items-center">
                ...
                <div className="relative w-24 h-24 mb-8">
                    <div className="absolute inset-0 bg-purple-600/20 rounded-2xl blur-xl animate-pulse"></div>
                    <div className="relative w-full h-full gradient-bg-primary rounded-2xl flex items-center justify-center shadow-2xl shadow-purple-500/20 animate-bounce-slight">
